# Clínica Dental – Base de Datos (MySQL)

Este repositorio contiene la base de datos del proyecto académico **Clínica Dental**, desarrollada para la asignatura de Ingeniería de Sistemas. Incluye:

- Script de creación de tablas (DDL)
- Inserción de registros iniciales (DML)
...
<img width="1343" height="765" alt="create1" src="https://github.com/user-attachments/assets/5fb69e56-82ef-4ec7-aa4a-74545469e771" />
<img width="1339" height="665" alt="create2" src="https://github.com/user-attachments/assets/e4ef94ba-9099-4e34-979c-4d999ccd3c91" />
<img width="1341" height="688" alt="create3" src="https://github.com/user-attachments/assets/abfb75d7-7459-4a89-aa9a-2a75e8d3ad02" />
**- Insertar datos a la tabla**
<img width="1340" height="617" alt="insert1" src="https://github.com/user-attachments/assets/c3562d76-c04e-4645-95af-0264c8ccf6ae" />
<img width="1342" height="697" alt="insert2" src="https://github.com/user-attachments/assets/4f9750fe-3555-4bec-871c-5b3984348f1b" />
<img width="1339" height="616" alt="insert3" src="https://github.com/user-attachments/assets/a9565dfe-8c4e-4473-9359-d9e514f3fa05" />
**- Consultas**
